...
//TODO Currency-specific address prefix -DONE
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0xe9; // addresses start with "ae";
...
const uint64_t MONEY_SUPPLY                                  = UINT64_C(95999999999900000000);
...
const char     CRYPTONOTE_NAME[]                             = "coinae";
...
const int      P2P_DEFAULT_PORT                              = 16807;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 16808;
